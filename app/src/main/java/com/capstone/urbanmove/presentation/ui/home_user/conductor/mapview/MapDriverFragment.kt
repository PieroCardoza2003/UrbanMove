...
class MapDriverFragment : Fragment(), OnMapReadyCallback {
    ...
    private var _binding: FragmentMapDriverBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentMapDriverBinding.inflate(inflater, container, false)
        ...
        viewModel.driver_data.observe(viewLifecycleOwner){ usuario ->
            if (usuario.foto_perfil != null){
                Glide.with(requireContext())
                    ...
                    .into(binding.imagenPerfilDriver)
            }
        }

        val bottomSheet: View = binding.bottomSheetDriver
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        drawerLayout = requireActivity().findViewById(R.id.drawer_layout_driver)

        val mapFragment = childFragmentManager.findFragmentById(R.id.fragment_map_driver) as SupportMapFragment
